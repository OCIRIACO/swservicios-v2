...
export class RenderAcciones {
  ...
  e_editar() {
    this.router.navigate(['dashboard/intranet/cliente/directo/editar', this.parametros.data.ecodcliente ]);  // nativo
  }

  e_detalle(){
    this.router.navigate(['dashboard/intranet/cliente/directo/detalle', this.parametros.data.ecodcliente ]);  // nativo
  }
