...
@Component({
  selector: 'app-detalle-servicio-carga',
  templateUrl: './detalle-servicio-carga.component.html',
  styleUrls: ['./detalle-servicio-carga.component.css']
})
export class DetalleServicioCargaComponent implements OnInit {
