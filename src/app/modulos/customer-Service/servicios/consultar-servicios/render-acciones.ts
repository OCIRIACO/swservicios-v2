...
export class RenderAcciones {
  ...
  e_editar() {
    this.router.navigate(['dashboard/customer/servicios/editar', this.parametros.data.folioweb ]);  // nativo
  }

  e_detalle(){
    this.router.navigate(['dashboard/customer/servicios/detalle', this.parametros.data.folioweb ]);  // nativo
  }
