...
export class RenderAcciones {
  ...
  e_editar() {
    this.router.navigate(['dashboard/customer/transporte/editar', this.parametros.data.folioweb]);  // nativo
  }

  e_detalle() {
    this.router.navigate(['dashboard/customer/transporte/detalle', this.parametros.data.folioweb]);  // nativo
  }
