...
@Component({
  selector: 'app-crear-autotransporte',
  templateUrl: './crear-autotransporte.component.html',
  styleUrls: ['./crear-autotransporte.component.css']
})
export class CrearAutotransporteComponent implements OnInit {
  ...
  e_generarSolicitudServicio(datos: any) {
    ...
    //Consumir el api
    this.apiServiceSolicitudServicios.postCrearSolicitudAutotransporte(datos).subscribe(
      (response) => {
